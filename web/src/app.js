...
const translations = {
    zh: {
        ...
        hint: '支持 <strong>TikZ ↔ CeTZ</strong> 图形互转 <span style="margin: 0 8px; opacity: 0.4">|</span> 宏功能 (Macro) 仅在 <strong>文档模式</strong> 下生效',
        chars: '字符',
        ready: '就绪',
        converting: '转换中...',
        time: '转换耗时',
    ...
    en: {
        ...
        hint: 'Supports <strong>TikZ ↔ CeTZ</strong> graphics conversion <span style="margin: 0 8px; opacity: 0.4">|</span> Macros only work in <strong>Document Mode</strong>',
        chars: 'chars',
        ready: 'Ready',
